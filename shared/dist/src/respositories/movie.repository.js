...
class MovieRepository {
    ...
    findAll(reqQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { count, rows } = yield movies_1.default.findAndCountAll({
                where: query.filter(),
    ...
    findMovieWithAssociates(movieId) {
        return __awaiter(this, void 0, void 0, function* () {
            let movie = null;
            try {
                movie = yield movies_1.default.findByPk(movieId, {
                    include: [movies_1.default.associations.showTimes],
                    rejectOnEmpty: true,
                });
            }
            catch (error) {
